// AcquisitionNumber.h
#ifndef DICOM_ACQUISITIONNUMBER_TAG_H
#define DICOM_ACQUISITIONNUMBER_TAG_H
...
class CAcquisitionNumber : public CDicomTag
{
private:
...
public:
	 ...
	 *********************
	 * @pre Group == 0x0020 && Element 0x0012
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CAcquisitionNumber						( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );

	/**
	 * Accessor.
	 *********************
	 * @return const int32 : acquisition number
	 */
    const int32				GetNumber								( void ) const ;
...
#endif // DICOM_ACQUISITIONNUMBER_TAG_H
