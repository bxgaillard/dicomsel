// PixelData.h
#ifndef DICOM_PIXELDATA_TAG_H
#define DICOM_PIXELDATA_TAG_H
...
class CPixelData : public CDicomTag
{
    bool m_bLastPicture;
    char* m_pBuffer;
	uint32 m_ui32Size;
...
public :
	 ...
	 *********************
	 * @pre Group == 0x7FE0 && Element 0x0010
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CPixelData								( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );
	...
	void					SetSize									( const uint32 _ui32Size ) {this->m_ui32Size = _ui32Size ; }

    const bool				IsLastPicture							( void ) const ;
