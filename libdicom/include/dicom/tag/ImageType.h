// ImageType.h
#ifndef DICOM_IMAGETYPE_TAG_H
#define DICOM_IMAGETYPE_TAG_H
...
class CImageType : public CTagWithStringValue
{
public :
	/**
	 * Constructor.
	 ...
	 *********************
	 * @pre Group == 0x0008 && Element 0x0008
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CImageType								( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );
