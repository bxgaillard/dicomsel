// AcquisitionZone.h
#ifndef DICOM_ACQUISITIONZONE_TAG_H
#define DICOM_ACQUISITIONZONE_TAG_H
...
class CAcquisitionZone : public CTagWithStringValue
{
public :
	/**
	 * Constructor.
	 ...
	 *********************
	 * @pre Group == 0x0008 && Element 0x1030
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CAcquisitionZone						( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );

	/**
	 * Accessor.
	 *********************
	 * @return const std::string& : acquisition zone (eg "Abdomen")
	 */
    const std::string&		GetZone									( void ) const ;
...
#endif // DICOM_ACQUISITIONZONE_TAG_H
