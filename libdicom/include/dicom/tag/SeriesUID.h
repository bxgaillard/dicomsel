// SeriesUID.h
#ifndef DICOM_SeriesUID_TAG_H
#define DICOM_SeriesUID_TAG_H
...
class CSeriesUID : public CTagWithStringValue
{
public :
	/**
	 * Constructor.
	 ...
	 *********************
	 * @pre Group == 0x0020 && Element 0x000e
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CSeriesUID								( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );
