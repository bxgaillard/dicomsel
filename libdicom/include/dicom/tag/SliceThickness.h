// SliceThickness.h
#ifndef DICOM_SLICETHICKNESS_TAG_H
#define DICOM_SLICETHICKNESS_TAG_H
...
class CSliceThickness : public CDicomTag
{
private:
    double m_sSliceThickness;
public :
	/**
	 * Constructor.
	 ...
	 *********************
	 * @pre Group == 0x0018 && Element 0x0050
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CSliceThickness							( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );

    const double			GetThickness							( void ) const ;
...
#endif // DICOM_SLICETHICKNESS_TAG_H
