// Columns.h
#ifndef DICOM_COLUMNS_TAG_H
#define DICOM_COLUMNS_TAG_H
...
class CColumns : public CDicomTag
{
private:
    uint16  m_ui32Width;
...
public :
	 ...
	 *********************
	 * @pre Group == 0x0028 && Element 0x0011
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CColumns								( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );
