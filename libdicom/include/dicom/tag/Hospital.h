// Hospital.h
#ifndef DICOM_HOSPITAL_TAG_H
#define DICOM_HOSPITAL_TAG_H
...
class CHospital : public CTagWithStringValue
{
public :
	/**
	 * Constructor.
	 ...
	 *********************
	 * @pre Group == 0x0008 && Element 0x0080
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CHospital								( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );

    const std::string&		GetHospitalPatient						( void ) const ;
