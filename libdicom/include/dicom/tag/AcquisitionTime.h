// AcquisitionTime.h
#ifndef DICOM_ACQUISITIONTIME_TAG_H
#define DICOM_ACQUISITIONTIME_TAG_H
...
class CAcquisitionTime : public CTagWithStringValue
{
public :
	/**
	 * Constructor.
	 ...
	 *********************
	 * @pre Group == 0x0008 && Element 0x0032
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CAcquisitionTime						( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );

	/**
	 * Accessor.
	 *********************
	 * @return const std::string& : acquisition Time (yyyymmdd format)
	 */
    const std::string&		GetAcquisitionTime						( void ) const ;
...
#endif // DICOM_ACQUISITIONTIME_TAG_H
