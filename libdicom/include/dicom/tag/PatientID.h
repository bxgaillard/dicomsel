// PatientID.h
#ifndef DICOM_PATIENTID_TAG_H
#define DICOM_PATIENTID_TAG_H
...
class CPatientID : public CTagWithStringValue
{
public :
	/**
	 * Constructor.
	 ...
	 *********************
	 * @pre Group == 0x0010 && Element 0x0020
	 *********************
	 * @see dicom::tag::CDicomTag
	 */
    explicit				CPatientID								( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );
