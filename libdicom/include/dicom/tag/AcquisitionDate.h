// AcquisitionDate.h
#ifndef DICOM_ACQUISITIONDATE_TAG_H
#define DICOM_ACQUISITIONDATE_TAG_H
...
class CAcquisitionDate : public CTagWithStringValue
{
public:
	/**
	 * Constructor.
	 ...
	 */
    explicit				CAcquisitionDate						( const int32 _i32Group, const int32 _i32Element, const int32 _i32Length );

	/**
	 * Accessor.
	 *********************
	 * @return const std::string& : acquisition date (yyyymmdd format)
	 */
    const std::string&		GetAcquisitionDate						( void ) const ;
...
#endif // DICOM_ACQUISITIONDATE_TAG_H
